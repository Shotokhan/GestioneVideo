package src.is.gestionevideo;

import java.time.LocalDate;
import java.time.Month;
import java.util.ArrayList;

import src.is.gestionevideo.control.GestioneVideo;
import src.is.gestionevideo.entity.Giornalista;
import src.is.gestionevideo.entity.Sport;
import src.is.gestionevideo.entity.Video;
import src.is.gestionevideo.entity.VideoApprofondimento;
import src.is.gestionevideo.entity.VideoEvento;
